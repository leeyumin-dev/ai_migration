...
import EgovQna from "@/components/EgovQna";
import { getSessionItem } from "@/utils/storage";

function EgovQnaDetail(props) {
  console.group("EgovQnaDetail");
  console.log("------------------------------");
  console.log("EgovQnaDetail [props] : ", props);

  const navigate = useNavigate();
  const location = useLocation();
  console.log("EgovQnaDetail [location] : ", location);
  ...
  const onClickDeleteBoardArticle = (bbsId, nttId, atchFileId) => {
    ...
    EgovNet.requestFetch(deleteBoardURL, requestOptions, (resp) => {
      ...
      if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
        alert("게시글이 삭제되었습니다.");
        navigate(URL.INFORM_QNA, { replace: true });
      } else {
        navigate(
          { pathname: URL.ERROR },
  ...
  console.groupEnd("EgovQnaDetail");
        ...
        <div className="layout">
          ...
          <div className="contents NOTICE_VIEW" id="contents">
            ...
            <div className="board_view">
              ...
              <EgovQna boardFiles={boardAttachFiles} />
                ...
                {sessionUniqId === boardDetail.frstRegisterId &&
                  ...
                  masterBoard.bbsUseFlag === "Y" && (
                    <div className="left_col btn3">
                      <Link
                        to={{ pathname: URL.INFORM_QNA_MODIFY }}
                        state={{
                          nttId: nttId,
                          bbsId: bbsId,
                        }}
                      ...
                      {user &&
                        ...
                        <Link
                          to={{ pathname: URL.INFORM_QNA_REPLY }}
                          state={{
                            nttId: nttId,
                            bbsId: bbsId,
                          }}
