...
function EgovQnaEdit(props) {
  console.group("EgovQnaEdit");
  console.log("------------------------------");
  console.log("EgovQnaEdit [props] : ", props);
  //관리자 권한 체크때문에 추가(아래)
  ...
  console.log("EgovQnaEdit [location] : ", location);
    ...
    if (bbsFormVaildator(formData)) {
      ...
      EgovNet.requestFetch(modeInfo.editURL, requestOptions, (resp) => {
        if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
          navigate(URL.INFORM_QNA, { state: { bbsId: bbsId } });
        } else {
